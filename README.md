...
* Рефакторинг Js
* Реализация API
* Добавлены и реализована функциональность классоа PopupWithRemove
* Доработан класс Card для работы с новыми классами
* Реализован динамический обмен данными с сервером (Добавление/Удаление карточек, Лайки, Инфо Профиля, Аватар)
* Улучшен UX 
